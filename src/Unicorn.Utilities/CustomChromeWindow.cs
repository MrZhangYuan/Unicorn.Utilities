...
using Unicorn.Utilities.Extensions;
using Unicorn.Utilities.Internal;
using Unicorn.Utilities.Internal.MSCopy;
...
namespace Unicorn.Utilities
{
    public class CustomChromeWindow : Window
    {
        ...
        private sealed class GlowBitmap : DisposableObject
        {
            ...
            {
                this._bitmapInfo.biSize = Marshal.SizeOf(typeof(NativeMethods.BITMAPINFOHEADER));
                ...
                this._hBitmap = NativeMethods.CreateDIBSection(
                        hdcScreen,
            ...
            {
                NativeMethods.DeleteObject(this._hBitmap);
            }
        ...
        private sealed class GlowDrawingContext : DisposableObject
        {
            ...
            {
                this.hdcScreen = NativeMethods.GetDC(IntPtr.Zero);
                if (this.hdcScreen == IntPtr.Zero)
                {
                    return;
                }
                this.hdcWindow = NativeMethods.CreateCompatibleDC(this.hdcScreen);
                if (this.hdcWindow == IntPtr.Zero)
                {
                    return;
                }
                this.hdcBackground = NativeMethods.CreateCompatibleDC(this.hdcScreen);
                ...
                NativeMethods.SelectObject(this.hdcWindow, this.windowBitmap.Handle);
            }
            protected override void DisposeManagedResources()
            {
            ...
            protected override void DisposeNativeResources()
            {
                if (this.hdcScreen != IntPtr.Zero)
                {
                    NativeMethods.ReleaseDC(IntPtr.Zero, this.hdcScreen);
                }
                if (this.hdcWindow != IntPtr.Zero)
                {
                    NativeMethods.DeleteDC(this.hdcWindow);
                }
                if (this.hdcBackground != IntPtr.Zero)
                {
                    NativeMethods.DeleteDC(this.hdcBackground);
                }
            }
        }
        private sealed class GlowWindow : HwndWrapper
        {
                ...
                get
                {
                    if (CustomChromeWindow.GlowWindow._sharedWindowClassAtom == 0)
                    {
                        ...
                        wNDCLASS.lpfnWndProc = (CustomChromeWindow.GlowWindow._sharedWndProc =
                                new NativeMethods.WndProc(NativeMethods.DefWindowProc));

                        wNDCLASS.lpszClassName = "VisualStudioGlowWindow";
                        wNDCLASS.lpszMenuName = null;
                        wNDCLASS.style = 0u;

                        CustomChromeWindow.GlowWindow._sharedWindowClassAtom = NativeMethods.RegisterClass(ref wNDCLASS);
                    }
            ...
            private void UpdateWindowPosCore()
            {
                        ...
                        this._invalidatedValues.HasFlag(CustomChromeWindow.GlowWindow.FieldInvalidationTypes.Visibility))
                {
                    ...
                    NativeMethods.SetWindowPos(base.Handle, IntPtr.Zero, this.Left, this.Top, this.Width, this.Height, num);
                }
            }
            ...
            private void DrawLeft(CustomChromeWindow.GlowDrawingContext drawingContext)
            {
                ...
                NativeMethods.AlphaBlend(drawingContext.WindowDC, 0, 0, orCreateBitmap.Width, orCreateBitmap.Height, drawingContext.BackgroundDC, 0, 0, orCreateBitmap.Width, orCreateBitmap.Height, drawingContext.Blend);
                NativeMethods.SelectObject(drawingContext.BackgroundDC, orCreateBitmap2.Handle);
                NativeMethods.AlphaBlend(drawingContext.WindowDC, 0, height, orCreateBitmap2.Width, orCreateBitmap2.Height, drawingContext.BackgroundDC, 0, 0, orCreateBitmap2.Width, orCreateBitmap2.Height, drawingContext.Blend);
                if (num4 > 0)
                {
                    NativeMethods.SelectObject(drawingContext.BackgroundDC, orCreateBitmap3.Handle);
                    NativeMethods.AlphaBlend(drawingContext.WindowDC, 0, num, orCreateBitmap3.Width, num4, drawingContext.BackgroundDC, 0, 0, orCreateBitmap3.Width, orCreateBitmap3.Height, drawingContext.Blend);
                }
                NativeMethods.SelectObject(drawingContext.BackgroundDC, orCreateBitmap4.Handle);
                NativeMethods.AlphaBlend(drawingContext.WindowDC, 0, num3, orCreateBitmap4.Width, orCreateBitmap4.Height, drawingContext.BackgroundDC, 0, 0, orCreateBitmap4.Width, orCreateBitmap4.Height, drawingContext.Blend);
                NativeMethods.SelectObject(drawingContext.BackgroundDC, orCreateBitmap5.Handle);
                NativeMethods.AlphaBlend(drawingContext.WindowDC, 0, num2, orCreateBitmap5.Width, orCreateBitmap5.Height, drawingContext.BackgroundDC, 0, 0, orCreateBitmap5.Width, orCreateBitmap5.Height, drawingContext.Blend);
            }
            ...
            private void DrawTop(CustomChromeWindow.GlowDrawingContext drawingContext)
            {
                ...
                int num4 = num3 - num2;
                NativeMethods.SelectObject(drawingContext.BackgroundDC, orCreateBitmap.Handle);
                NativeMethods.AlphaBlend(drawingContext.WindowDC, num, 0, orCreateBitmap.Width, orCreateBitmap.Height, drawingContext.BackgroundDC, 0, 0, orCreateBitmap.Width, orCreateBitmap.Height, drawingContext.Blend);
                if (num4 > 0)
                {
                    NativeMethods.SelectObject(drawingContext.BackgroundDC, orCreateBitmap2.Handle);
                    NativeMethods.AlphaBlend(drawingContext.WindowDC, num2, 0, num4, orCreateBitmap2.Height, drawingContext.BackgroundDC, 0, 0, orCreateBitmap2.Width, orCreateBitmap2.Height, drawingContext.Blend);
                }
                NativeMethods.SelectObject(drawingContext.BackgroundDC, orCreateBitmap3.Handle);
                NativeMethods.AlphaBlend(drawingContext.WindowDC, num3, 0, orCreateBitmap3.Width, orCreateBitmap3.Height, drawingContext.BackgroundDC, 0, 0, orCreateBitmap3.Width, orCreateBitmap3.Height, drawingContext.Blend);
            }
            ...
            public void UpdateWindowPos()
            {
                IntPtr targetWindowHandle = this.TargetWindowHandle;
                RECT rECT;
                NativeMethods.GetWindowRect(targetWindowHandle, out rECT);
        ...
        protected virtual bool ShouldShowGlow
        {
            get
            {
                ...
                return NativeMethods.IsWindowVisible(handle) && !NativeMethods.IsIconic(handle) && !NativeMethods.IsZoomed(handle) && base.ResizeMode != ResizeMode.NoResize;
            }
        }
        ...
        private static void RaiseNonClientMouseMessageAsClient(IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam)
        {
            ...
            NativeMethods.SendMessage(hWnd, msg + 513 - 161, new IntPtr(CustomChromeWindow.PressedMouseButtons), NativeMethods.MakeParam(pOINT.X, pOINT.Y));
        }
        private IntPtr CallDefWindowProcWithoutVisibleStyle(IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            ...
            IntPtr result = NativeMethods.DefWindowProc(hWnd, msg, wParam, lParam);
            if (flag)
            {
        ...
        private void WmActivate(IntPtr wParam, IntPtr lParam)
        {
            ...
            {
                NativeMethods.SendMessage(this.ownerForActivate, NativeMethods.NOTIFYOWNERACTIVATE, wParam, lParam);
            }
        }
        ...
        private IntPtr WmNcPaint(IntPtr hWnd, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            if (this._isNonClientStripVisible)
            {
                ...
                IntPtr dCEx = NativeMethods.GetDCEx(hWnd, hrgnClip, 155);
                if (dCEx != IntPtr.Zero)
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            NativeMethods.FillRect(dCEx, ref clientRectRelativeToWindowRect, intPtr);
                        }
                        finally
                        {
        ...
        private IntPtr WmNcCalcSize(IntPtr hWnd, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            ...
            WINDOWPLACEMENT windowPlacement = NativeMethods.GetWindowPlacement(hWnd);
        ...
        private IntPtr WmNcHitTest(IntPtr hWnd, IntPtr lParam, ref bool handled)
        {
            ...
            System.Windows.Point point = new System.Windows.Point((double)NativeMethods.GetXLParam(lParam.ToInt32()), (double)NativeMethods.GetYLParam(lParam.ToInt32()));
        ...
        {
            int num = NativeMethods.GET_SC_WPARAM(wParam);
            if (num == 61456)
            {
        ...
        internal Rect GetOnScreenPosition(Rect floatRect)
        {
            ...
            {
                Screen.FindMonitorRectsFromPoint(NativeMethods.GetCursorPos(), out rect, out rect2);
        ...
        private void UpdateZOrderOfThisAndOwner()
        {
            ...
            try
            {
                ...
                {
                    IntPtr window = NativeMethods.GetWindow(current.Handle, 3);
                    if (window != handle)
                    {
                        NativeMethods.SetWindowPos(current.Handle, handle, 0, 0, 0, 0, 19);
                    }
        ...
        protected void UpdateClipRegion(CustomChromeWindow.ClipRegionChangeType regionChangeType = CustomChromeWindow.ClipRegionChangeType.FromPropertyChange)
        {
            ...
            {
                RECT currentBounds;
                NativeMethods.GetWindowRect(hwndSource.Handle, out currentBounds);
                WINDOWPLACEMENT windowPlacement = NativeMethods.GetWindowPlacement(hwndSource.Handle);
        ...
        private void UpdateMaximizedClipRegion(IntPtr hWnd)
        {
            ...
            IntPtr hRgn = NativeMethods.CreateRectRgnIndirect(ref clientRectRelativeToWindowRect);
        ...
        private static MONITORINFO MonitorInfoFromWindow(IntPtr hWnd)
        {
            ...
            NativeMethods.GetMonitorInfo(hMonitor, ref result);
            return result;
        }
        ...
        protected IntPtr ComputeCornerRadiusRectRegion(Int32Rect rect, CornerRadius cornerRadius)
        {
            ...
            try
            {
                ...
                intPtr5 = NativeMethods.CreateRectRgn(rect.X, rect.Y, pOINT.X + 1, pOINT.Y + 1);
                intPtr6 = NativeMethods.CreateRectRgn(pOINT.X - 1, rect.Y, rect.X + rect.Width, pOINT.Y + 1);
                intPtr7 = NativeMethods.CreateRectRgn(rect.X, pOINT.Y - 1, pOINT.X + 1, rect.Y + rect.Height);
                intPtr8 = NativeMethods.CreateRectRgn(pOINT.X - 1, pOINT.Y - 1, rect.X + rect.Width, rect.Y + rect.Height);
                intPtr9 = NativeMethods.CreateRectRgn(0, 0, 1, 1);
                intPtr10 = NativeMethods.CreateRectRgn(0, 0, 1, 1);
                NativeMethods.CombineRgn(intPtr10, intPtr, intPtr5, NativeMethods.CombineMode.RGN_AND);
                NativeMethods.CombineRgn(intPtr9, intPtr2, intPtr6, NativeMethods.CombineMode.RGN_AND);
                NativeMethods.CombineRgn(intPtr10, intPtr10, intPtr9, NativeMethods.CombineMode.RGN_OR);
                NativeMethods.CombineRgn(intPtr9, intPtr3, intPtr7, NativeMethods.CombineMode.RGN_AND);
                NativeMethods.CombineRgn(intPtr10, intPtr10, intPtr9, NativeMethods.CombineMode.RGN_OR);
                NativeMethods.CombineRgn(intPtr9, intPtr4, intPtr8, NativeMethods.CombineMode.RGN_AND);
                NativeMethods.CombineRgn(intPtr10, intPtr10, intPtr9, NativeMethods.CombineMode.RGN_OR);
            }
            finally
            {
                ...
                {
                    NativeMethods.DeleteObject(intPtr5);
                }
                if (intPtr6 != IntPtr.Zero)
                {
                    NativeMethods.DeleteObject(intPtr6);
                }
                if (intPtr7 != IntPtr.Zero)
                {
                    NativeMethods.DeleteObject(intPtr7);
                }
                if (intPtr8 != IntPtr.Zero)
                {
                    NativeMethods.DeleteObject(intPtr8);
                }
                if (intPtr9 != IntPtr.Zero)
                {
                    NativeMethods.DeleteObject(intPtr9);
                }
            }
            return intPtr10;
        }
        ...
        {
            int systemMetrics = NativeMethods.GetSystemMetrics(40);
            IntPtr systemMenu = NativeMethods.GetSystemMenu(source.Handle, false);
            WINDOWPLACEMENT windowPlacement = NativeMethods.GetWindowPlacement(source.Handle);
            ...
            int num = NativeMethods.TrackPopupMenuEx(systemMenu, fuFlags, (int)screenPoint.X, (int)screenPoint.Y, source.Handle, IntPtr.Zero);
            if (num != 0)
            {
