...
namespace Unicorn.Utilities.Internal
{
    internal static class NativeMethods
    {
        ...
        internal struct BITMAPINFOHEADER
        {
            ...
            internal static NativeMethods.BITMAPINFOHEADER Default
            {
                get
                {
                    return new NativeMethods.BITMAPINFOHEADER
                    {
                        biSize = 40u,
                        biPlanes = 1
                    };
        ...
        internal class BITMAPFILEHEADER
        {
            ...
            internal static NativeMethods.BITMAPFILEHEADER Default
            {
                get
                {
                    return new NativeMethods.BITMAPFILEHEADER
                    {
                        bfSize = 14u
                    };
                }
        ...
        internal static int CombineRgn(IntPtr hrnDest, IntPtr hrgnSrc1, IntPtr hrgnSrc2, NativeMethods.CombineMode combineMode)
        {
            return NativeMethods.CombineRgn(hrnDest, hrgnSrc1, hrgnSrc2, (int)combineMode);
        }
        [DllImport("User32.dll", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        ...
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool UpdateLayeredWindow(IntPtr hwnd, IntPtr hdcDest, ref POINT pptDest, ref SIZE psize, IntPtr hdcSrc, ref POINT pptSrc, uint crKey, [In] ref NativeMethods.BLENDFUNCTION pblend, uint dwFlags);
        [DllImport("user32.dll")]
        public static extern bool RedrawWindow(IntPtr hWnd, IntPtr lprcUpdate, IntPtr hrgnUpdate, NativeMethods.RedrawWindowFlags flags);
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
